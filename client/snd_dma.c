...
void S_ClearBuffer (void)
{
	...
	if (dma.buffer)
		d_memset(dma.buffer, clear, dma.samples * dma.samplebits/8);
	SNDDMA_Submit ();
}
...
void S_StopAllSounds(void)
{
	...
	d_memset(s_playsounds, 0, sizeof(s_playsounds));
	...
	d_memset(channels, 0, sizeof(channels));
